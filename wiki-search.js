...
const WIKI_INDEX = [
  ...
  // Bøker — 12 små profeter
  { type: "page", icon: "💔", title: "Hosea", subtitle: "Bok · Ekteskap som profeti — Gomer, hjerteklage",
    url: "hosea-tidslinje.html", keywords: ["hosea", "gomer", "samaria", "kjaerlighet", "horkvinne", "nordriket"] },
  { type: "page", icon: "🌾", title: "Joel", subtitle: "Bok · Gresshoppe-plagen og Herrens dag",
    url: "joel-tidslinje.html", keywords: ["joel", "gresshoppe", "herrens dag", "anden", "pinsedagen", "utose"] },
  { type: "page", icon: "⚖️", title: "Amos", subtitle: "Bok · Bonde fra Tekoa — sosial dom",
    url: "amos-tidslinje.html", keywords: ["amos", "tekoa", "rett", "sosial urett", "samaria", "bethel", "amasja"] },
  { type: "page", icon: "🗡️", title: "Obadja", subtitle: "Bok · Dommen over Edom — 21 vers",
    url: "obadja-tidslinje.html", keywords: ["obadja", "obadiah", "edom", "esau", "petra"] },
  { type: "page", icon: "🐋", title: "Jonas", subtitle: "Bok · Profeten som rømte — fisken og Ninive",
    url: "jonas-tidslinje.html", keywords: ["jonas", "jonah", "fisken", "ninive", "tarsjisj", "joppe", "nadig"] },
  { type: "page", icon: "🏘️", title: "Mika", subtitle: "Bok · Betlehems profet — gjøre rett, vise miskunn",
    url: "mika-tidslinje.html", keywords: ["mika", "micah", "betlehem", "rettferdig", "miskunn", "hyrde", "messias"] },
  { type: "page", icon: "🔥", title: "Nahum", subtitle: "Bok · Ninives endelige fall",
    url: "nahum-tidslinje.html", keywords: ["nahum", "ninive", "blodbyen", "assyria"] },
  { type: "page", icon: "🤔", title: "Habakkuk", subtitle: "Bok · Den rettferdige skal leve ved tro",
    url: "habakkuk-tidslinje.html", keywords: ["habakkuk", "tro", "rettferdig", "kalde", "fikentre", "salme"] },
  { type: "page", icon: "⚡", title: "Sefanja", subtitle: "Bok · Herrens dag — og en sang av glede",
    url: "sefanja-tidslinje.html", keywords: ["sefanja", "zephaniah", "herrens dag", "rest", "synger"] },
  { type: "page", icon: "🏗️", title: "Haggai", subtitle: "Bok · Bygg tempelet — vekk apatien",
    url: "haggai-tidslinje.html", keywords: ["haggai", "tempel", "serubabel", "jesjua", "signetring"] },
  { type: "page", icon: "🐎", title: "Sakarja", subtitle: "Bok · Messianske syner — kongen på eselet",
    url: "sakarja-tidslinje.html", keywords: ["sakarja", "zechariah", "esel", "konge", "tretti solvstykker", "gjennomstunget", "olivenfjellet"] },
